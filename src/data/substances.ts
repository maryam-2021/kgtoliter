...
import { top50Substances } from './curatedSubstances';

// Curated Top 50 substances array for individual SEO pages
export const substances: Substance[] = top50Substances;
...
export const featuredSubstances = [
  {
    id: 'water',
    name: 'Water',
    density: 1.0,
    category: 'beverages',
    icon: '💧',
    description: 'Pure water at room temperature (20°C). Reference density for all conversions.',
    seoTitle: 'Water Kilograms to Liters Conversion',
    seoDescription: 'Convert water from kg to liters instantly. 1 kg water = 1 liter at 20°C.',
    keywords: 'water kg to liters, convert water kilograms to liters, water density',
  },
  {
    id: 'milk',
    name: 'Milk',
    ...
    category: 'dairy',
    icon: '🥛',
    description: 'Whole milk with 3.25% fat content. Density varies slightly with fat content.',
    seoTitle: 'Milk Kilograms to Liters Conversion',
    seoDescription: 'Convert milk from kg to liters. 1 kg milk = 0.971 liters at 20°C.',
    keywords: 'milk kg to liters, convert milk kilograms to liters, milk density',
  },
  {
    id: 'olive-oil',
    name: 'Olive Oil',
    ...
    icon: '🫒',
    description: 'Extra virgin olive oil. Density varies by temperature and quality.',
    seoTitle: 'Olive Oil Kilograms to Liters Conversion',
    seoDescription: 'Convert olive oil from kg to liters. 1 kg olive oil = 1.099 liters.',
    keywords: 'olive oil kg to liters, convert olive oil to liters, olive oil density',
  },
  {
    id: 'honey',
    name: 'Honey',
    ...
    category: 'sweeteners',
    icon: '🍯',
    description: 'Natural honey. Density varies by floral source and moisture content.',
    seoTitle: 'Honey Kilograms to Liters Conversion',
    seoDescription: 'Convert honey from kg to liters. 1 kg honey = 0.704 liters.',
    keywords: 'honey kg to liters, convert honey to liters, honey density',
  },
  {
    id: 'diesel',
    name: 'Diesel',
    ...
    category: 'petroleum',
    icon: '⛽',
    description: 'Standard diesel fuel (#2). Density varies with temperature and season.',
    seoTitle: 'Diesel Kilograms to Liters Conversion',
    seoDescription: 'Convert diesel from kg to liters. 1 kg diesel = 1.202 liters.',
    keywords: 'diesel kg to liters, convert diesel to liters, diesel density',
  },
  {
    id: 'gasoline',
    name: 'Gasoline',
    ...
    category: 'petroleum',
    icon: '⛽',
    description: 'Regular unleaded gasoline (87 octane). Density varies with blend.',
    seoTitle: 'Gasoline Kilograms to Liters Conversion',
    seoDescription: 'Convert gasoline from kg to liters. 1 kg gasoline = 1.337 liters.',
    keywords: 'gasoline kg to liters, convert gasoline to liters, gasoline density',
  },
];
